...
\begin{proposition}
  ...
  Let $p$ be an odd prime and let $K/\QQ$ be a cyclic extension of degree $p$
  unramified outside $p$. Then $K$ admits a $\QQ$-algebra embedding into
  $\QQ(\zeta_{p^2})$. In particular $K$ is the unique subfield of degree $p$ of
  $\QQ(\zeta_{p^2})$, and the maximal abelian extension of $\QQ$ of exponent $p$
