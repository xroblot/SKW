...
\begin{proof}
  Standard tame-ramification theory (the tame character); see e.g.\ Serre, \emph{Local Fields},
  Ch.~IV, or Marcus, \emph{Number Fields}. Well-definedness and injectivity use that $e$ is
  prime to the residue characteristic, and the image lies in the group of $e$-th roots of unity
  of $k(\mathfrak{Q})$.
\end{proof}
