...
\begin{proposition}
  ...
  \uses{prop:kw_2_quadratic}
  Any two totally real quadratic extensions of $\QQ$ unramified outside $2$ coincide (both equal
  $\QQ(\sqrt 2) = \QQ(\zeta_8)^+$).
\end{proposition}

\begin{proof}
  By \ref{prop:kw_2_quadratic} each lies in $\QQ(\zeta_8)$ and, being real of degree $2$, equals its
  unique real quadratic subfield $\QQ(\sqrt 2)$.
\end{proof}
