...
\begin{proof}
  ...
  By \ref{lem:kw_kummer}, $L/F$ is unramified at $\mathfrak{q}$.
  Since $L = F(\sqrt[p]{\mu})$ is a Kummer extension, the local Kummer
  ramification criterion gives: $F(\sqrt[p]{\mu})/F$ is unramified at
  $\mathfrak{q}$ if and only if $p \mid v_{\mathfrak{q}}(\mu)$.
  Hence $p \mid r$.
